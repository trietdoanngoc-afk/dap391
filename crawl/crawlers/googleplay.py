...
def crawl_google_play() -> pd.DataFrame:
    """
    Generate synthetic Google Play Store reviews for all banks.
    ...
    for bank_name in BANKS_ALL:
        ...
        df_bank = generate_dummy_reviews(bank_name, "google_play", count=500)
...
if __name__ == "__main__":
    df = crawl_google_play()
    
    output_path = Path(__file__).parent.parent / "data" / "raw" / "reviews_googleplay.csv"
